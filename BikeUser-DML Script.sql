...
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'johndoe@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Central Station'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 1), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Boston Station Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Charlestown Dock'), TO_DATE('2025-04-17 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-22 11:45:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'harvey@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Harvard Square'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 2), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Back Bay Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Cambridge Dock'), TO_DATE('2025-04-18 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-20 11:18:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'scottm@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'MIT Gate'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 3), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'South Boston Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Harborfront Dock'), TO_DATE('2025-04-20 08:45:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-21 11:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'snowyy@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Downtown Cambridge'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 4), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'North End Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Beacon Hill Dock'), TO_DATE('2025-04-21 10:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-21 12:50:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'megz@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'North Station'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 5), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Fenway Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Beacon Hill Dock'), TO_DATE('2025-04-19 09:10:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-20 10:40:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'beckham09@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Broadway 3rd'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 6), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Seaport Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'South Boston Dock'), TO_DATE('2025-04-18 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-22 12:50:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'kiaraadv@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'South End'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 7), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Beacon Hill Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Seaport Dock'), TO_DATE('2025-04-17 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-17 16:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'kingkhan@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Union Park'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 8), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Harborfront Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Fenway Dock'), TO_DATE('2025-04-18 13:15:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-19 14:45:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'kingkohli@xyz.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Tech Crossing'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 9), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Cambridge Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'North End Dock'), TO_DATE('2025-04-17 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-18 18:00:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Rental (Customer_ID, Bike_ID, Transaction_ID, Start_Dock_ID, End_Dock_ID, Start_Date_Time, End_Date_Time)
VALUES ((SELECT Customer_ID FROM Customer WHERE Email = 'vinay@test.com'), (SELECT Bike_ID FROM Bike WHERE Current_Location = 'Museum Square'), (SELECT Transaction_ID FROM Payment_Details WHERE Customer_ID = 10), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'Charlestown Dock'), (SELECT Dock_ID FROM Docks WHERE Dock_Name = 'South Boston Dock'), TO_DATE('2025-04-19 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2025-04-19 12:00:00', 'YYYY-MM-DD HH24:MI:SS'));
