...
VALUES ('John', 'Doe', 'johndoe@xyz.com', hash_password('john123'), '5555551234', '123 Bane Street', '11', 'Boston', 'MA', '01234');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Harvey', 'Specter', 'harvey@xyz.com', hash_password('harvey123'), '5555555678', '456 Broklyn Ave', '754', 'Boston', 'MA', '56789');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Micheal', 'Scott', 'scottm@xyz.com', hash_password('scottm123'), '5555559123', '7 Dunder Mifflin', '-', 'Boston', 'MA', '22178');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Claire', 'Dunphy', 'claire@xyz.com', hash_password('claire123'), '5555554567', '88 Mass Ave', '7', 'Boston', 'MA', '22178');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('John', 'Snow', 'snowyy@xyz.com', hash_password('snowyy987'), '5555558912', '456 Broklyn Ave', '655', 'Boston', 'MA', '56789');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Meghan', 'Markle', 'megz@xyz.com', hash_password('megamark'), '5555553456', '456 Broklyn Ave', '1001', 'Boston', 'MA', '56789');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Victoria', 'Bekham', 'beckham09@xyz.com', hash_password('beckyvic'), '5555557891', '122 Bane Street', '4', 'Boston', 'MA', '01234');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Kiara', 'Malhotra', 'kiaraadv@xyz.com', hash_password('advanik123'), '5555552345', '92 Mass Ave', '5', 'Boston', 'MA', '22178');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Shahrukh', 'Khan', 'kingkhan@xyz.com', hash_password('badshah01'), '5555556789', '100 Bollywood St', '-', 'Boston', 'MA', '00112');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Virat', 'Kohli', 'kingkohli@xyz.com', hash_password('cricketking'), '5555551230', '101 Bollywood St', '-', 'Boston', 'MA', '00112');

INSERT INTO Customer (First_Name, Last_Name, Email, Cust_Password, Phone, Street_Address, House_Number, City, State_Code, ZIP)  
VALUES ('Vinay', 'Kumar', 'vinay@test.com', hash_password('test123'), '5505551230', '123 Main St', '9', 'Miami', 'FL', '98765');
